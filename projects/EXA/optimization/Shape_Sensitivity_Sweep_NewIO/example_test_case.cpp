 ...
 *
 * Twin of Shape_Sensitivity_Sweep/example_test_case.cpp for the Deck API v2 port:
 * identical analytical-vs-finite-difference sensitivity gates.
 */
...
namespace exa_shape_sensitivity_sweep_newio
{

    TEST_CASE( "Shape_Sensitivity_Sweep_NewIO",
            "[moris],[example],[optimization],[sweep],[EXA_Shape_Sensitivity_Sweep_NewIO]" )
    {
        // define command line call
        int argc = 2;

        char tString1[] = "";
        char tString2[] = "Shape_Sensitivity_Sweep_NewIO.so";
