...
namespace moris
{
    ...
    void FEMParameterList( Module_Parameter_Lists &aParameterLists )
    {
        ...
        // Register the IQI on the NONCONFORMAL contact set (not the bulk phase blocks): without
        // IQI_bulk_type the IQI matches 0 IQIs on the ncss set (nIQIonSet=0) and GAP writes the
        // uninitialized 0.0 everywhere. This is the actual fix for "GAP renders zero".
